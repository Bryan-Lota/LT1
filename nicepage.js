                ...
                var u = function() {
                    ...
                    init: function() {
                        if (!l && !c) {
                            ...
                            for (u += W ? "pswp--touch" : "pswp--notouch",
            ...
            return function(t, e) {
                var ui = this, n = false, i = true, o, a, s, u, l, c, f, h = true, p, m, g, v, y, w, b, C, S = {
                    ...
                    if (!(h = !h))
                        ...
                        setTimeout((function() {
                            if (!h)
                                e.addClass(f, "pswp__share-modal--fade-in")
                        }
                        ), 30);
                    else
                ...
                ui.init = function() {
                    ...
                    g("unbindEvents", (function() {
                        ...
                        if (B)
                            clearInterval(B);
                        if (e.unbind(document, "mouseout", z),
                        ...
                        o) {
                            if (e.unbind(document, o.eventK, ui.updateFullscreen),
                            o.isFullscreen())
                ...
                ui.updateIndexIndicator = function() {
                    if (C.counterEl)
                        l.innerHTML = t.getCurrentIndex() + 1 + C.indexIndicatorSep + C.getNumItemsFn()
                }
                ,
                        ...
                        if (n.detail && "mouse" === n.detail.pointerType) {
                            ...
                            if (C.tapToToggleControls)
                                if (i)
                                    ...
                                    ui.showControls();
                            if (C.tapToClose && (e.hasClass(o, "pswp__img") || O(o)))
                                return t.close(),
                                void 0
                        }
                }
 ...
 */
    ...
    11830: function(t, e, n) {
        "use strict";
        var i = n(15), GalleryLayout = n(11831), Filter;
    ...
    11860: function(t, e, n) {
        "use strict";
        var i = n(11861), o = n(11862), a = n(11868), s, u;
        new o(i).subscribe(),
        new a(i).subscribe()
    },
 ...
 */
    ...
    583: function(t, e, n) {
        ...
        i.registerAnimation(n(584)),
        i.registerAnimation(n(587)),
        i.registerAnimation(n(262))
    },
    584: function(t, e, n) {
        "use strict";
        function i(t, e) {
